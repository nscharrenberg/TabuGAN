"""Wrapper around Attention CTGAN model."""
...
class AttentionCTGANSynthesizer(LossValuesMixin, BaseSingleTableSynthesizer):
    ...
    def _fit(self, processed_data):
        ...
        self._model = AttentionCTGAN(**self._model_kwargs)
